...
function App() {
  ...
  return (
    <div className="container mx-auto">
      ...
      >
        <h1 className="text-3xl font-bold text-center">Images To PDF Converter</h1>
        <p className="text-center  text-2xl">Convert your multiple images into a single pdf file</p>
        {isComplete ? (
          <p className="text-center text-lime-400">100% Complete number of pages: {image.length}</p>
        ) : null}

        <div className="flex flex-col gap-2">
          <label
            className="flex flex-col items-center px-4 py-20 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white rounded-lg shadow-lg uppercase border border-white cursor-pointer "
          >
